...
{var locations=[];locations.push(clickedLocation);console.log(clickedLocation);var reqLat=clickedLocation.lat.toFixed(5);var reqLng=clickedLocation.lng.toFixed(5);var StrURL="https://www.freemaptools.com/uscript/v3/ajax/elevation-service.php?v=3&lat="+reqLat+"&lng="+reqLng;console.log(StrURL);$.ajax({url:StrURL,success:function(result){if(result)
